# mini-soc-network-analysis-lab
Overview

This  mini project simulates a basic Security Operations Center (SOC) environment using a Linux virtual machine. The goal was to generate, capture, and analyze network traffic to understand system communication behavior.
